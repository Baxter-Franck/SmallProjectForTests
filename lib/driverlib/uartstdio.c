...
//#undef UART_PRINTF_ENABLED
//#define UART_PRINTF_ENABLED
...
//
//*****************************************************************************
static uint32_t g_ui32Base = UART5_BASE;
...
{
    UART5_BASE, UART1_BASE, UART2_BASE //, UART7_BASE
};
...
{
    INT_UART5, INT_UART1, INT_UART2//, INT_UART7
};
...
{
    SYSCTL_PERIPH_UART7, SYSCTL_PERIPH_UART1, SYSCTL_PERIPH_UART2//, SYSCTL_PERIPH_UART7
};
